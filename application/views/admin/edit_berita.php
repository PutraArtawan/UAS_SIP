                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-primary">
                                    ...
                                    echo form_open_multipart("berita/edit_berita/" . $old_value['post_id'], $attributes);
                                    ?>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="post_title" class="control-lable">Kategori</label></br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="post_description" id="editor1" placeholder="Tambahkan disini" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $old_value["post_description"]; ?></textarea>
                                        </div>
                                    </div>
