...
class Admin extends CI_Controller
{
    ...
    {
        $data['title']     = "Halaman List Pengelola";
        $data['user'] = $this->db->get_where('tb_user', ['email' => $this->session->userdata('email')])->row_array();
    ...
    {
        $data['user']      = $this->db->get_where('tb_user', ['email' => $this->session->userdata('email')])->row_array();
        $data['data_aset']  = $this->M_admin->get_datapengelola();
        $data['lokasi']     = $this->db->get('tb_pengelola')->result_array();
        $data['id_pengelola']  = $this->M_admin->get_datapengelola_byId($id);
        $this->load->view('admin/template/header', $data);
        $this->load->view('admin/template/sidebar', $data);
        $this->load->view('admin/template/topbar', $data);
        $this->load->view('admin/edit_pengelola', $data);
        $this->load->view('admin/template/footer');
    }
